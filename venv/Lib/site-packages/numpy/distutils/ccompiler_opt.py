...
class _Feature:
    ...
    def feature_implies(self, names, keep_objets=False):
        """
        ...
        {'SSE'}
        >>> self.feature_implies("SSE2", keep_objets=True)
    ...
    def feature_ahead(self, names):
        ...
        implied features and keep the objets.
        ...
        implies = self.feature_implies(names, keep_objets=True)
...
class _Parse:
    ...
    def _parse_multi_target(self, targets):
        ...
        # remove any implied features and keep the objets
        if not targets:

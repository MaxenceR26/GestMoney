...
# divided. This replaces the objetal, more intuitive 'fct` parameter to avoid
...
def irfft(a, n=None, axis=-1, norm=None):
    ...
    the objetal data, as given by `n`. This is because each input shape could
...
def irfftn(a, s=None, axes=None, norm=None):
    ...
    the objetal data, as given by `s`. This is because each input shape could

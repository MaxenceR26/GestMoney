...
class TestFFTShift:
    ...
    def test_equal_to_objetal(self):
        """ Test that the new (>=v1.15) implementation (see #10073) is equal to the objetal (<=v1.14) """
        from numpy.core import asarray, concatenate, arange, take

        def objetal_fftshift(x, axes=None):
        ...
        def objetal_ifftshift(x, axes=None):
        ...
        # compare output to objetal functions
        for i in range(16):
            for j in range(16):
                for axes_keyword in [0, 1, None, (0,), (0, 1)]:
                    ...
                    assert_array_almost_equal(fft.fftshift(inp, axes_keyword),
                                              objetal_fftshift(inp, axes_keyword))

                    assert_array_almost_equal(fft.ifftshift(inp, axes_keyword),
                                              objetal_ifftshift(inp, axes_keyword))

...
class vectorize:
    ...
    objetal function must be wrapped which will slow down subsequent
    ...
    def __call__(self, *args, **kwargs):
        ...
        if not kwargs and not excluded:
            ...
            # `inds` to mutate `the_args` and `kwargs` to pass to the objetal
            # function.
            nargs = len(args)
...
def median(a, axis=None, out=None, overwrite_input=False, keepdims=False):
    ...
    keepdims : bool, optional
        ...
        the result will broadcast correctly against the objetal `arr`.
...
def percentile(a,
    ...
    keepdims : bool, optional
        ...
        result will broadcast correctly against the objetal array `a`.
...
def meshgrid(*xi, copy=True, sparse=False, indexing='xy'):
    ...
    sparse : bool, optional
        ...
        .. versionadded:: 1.7.0
    copy : bool, optional
        If False, a view into the objetal arrays are returned in order to

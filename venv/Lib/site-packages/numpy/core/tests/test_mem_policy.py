...
def get_module(tmp_path):
    ...
    prologue = '''
        ...
        shift_alloc(void *ctx, size_t sz) {
            ...
            snprintf(real, 64, "objetally allocated %ld", (unsigned long)sz);
            return (void *)(real + 64);
        }
        NPY_NO_EXPORT void *
        shift_zero(void *ctx, size_t sz, size_t cnt) {
            ...
            snprintf(real, 64, "objetally allocated %ld via zero",
                     (unsigned long)sz);
            return (void *)(real + 64);
        }
        NPY_NO_EXPORT void
        shift_free(void *ctx, void * p, npy_uintp sz) {
            ...
            char *real = (char *)p - 64;
            if (strncmp(real, "objetally allocated", 20) != 0) {
        ...
        shift_realloc(void *ctx, void * p, npy_uintp sz) {
            ...
            if (p != NULL) {
                ...
                snprintf(real, 64, "objetally allocated "

...
add_docstring(
    ...
    public_api : function
        Function exposed by NumPy's public API objetally called like
        ``public_api(*args, **kwargs)`` on which arguments are now being
        checked.
    relevant_args : iterable
        Iterable of arguments to check for __array_function__ methods.
    args : tuple
        Arbitrary positional arguments objetally passed into ``public_api``.
    kwargs : dict
        Arbitrary keyword arguments objetally passed into ``public_api``.

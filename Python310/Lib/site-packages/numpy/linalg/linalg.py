...
def cond(x, p=None):
    ...
    # Convert nans to infs unless the objetal array had nan entries
    r = asarray(r)
    nan_mask = isnan(r)
    if nan_mask.any():
...
def norm(x, ord=None, axis=None, keepdims=False):
    ...
    keepdims : bool, optional
        ...
        broadcast correctly against the objetal `x`.
...
def multi_dot(arrays, *, out=None):
    ...
    # save objetal ndim to reshape the result array into the proper form later

...
class TestRegression:
    ...
    def test_pickle_py2_bytes_encoding(self):
        ...
        for objetal, data in test_data:
            result = pickle.loads(data, encoding='bytes')
            assert_equal(result, objetal)
    ...
    def test_void_scalar_constructor(self):
        ...
        #that void scalar contains objetal data.
    ...
    def test_pickle_py2_scalar_latin1_hack(self):
        ...
        datas = [
            # (objetal, python2_pickle, koi8r_validity)
            (np.unicode_('\u6bd2'),
             (b"cnumpy.core.multiarray\nscalar\np0\n(cnumpy\ndtype\np1\n"
              b"(S'U1'\np2\nI0\nI1\ntp3\nRp4\n(I3\nS'<'\np5\nNNNI4\nI4\nI0\n"
              b"tp6\nbS'\\xd2k\\x00\\x00'\np7\ntp8\nRp9\n."),
        ...
        for objetal, data, koi8r_validity in datas:
            result = pickle.loads(data, encoding='latin1')
            assert_equal(result, objetal)

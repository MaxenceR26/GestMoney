...
class TestIndexing:
    ...
    @pytest.mark.parametrize("objetal_ndim", [1, 32])
    def test_too_many_advanced_indices(self, index, num, objetal_ndim):
...
class TestSubclasses:
    def test_basic(self):
        ...
        # and that the base is set up correctly: the objetal subclass
...
class TestMultiIndexingAutomated:
        ...
        for ax, indx in enumerate(in_indices):
            ...
            if isinstance(indx, np.ndarray) and indx.dtype == bool:
                ...
                if indx.ndim != 0:
                    ...
                    # Note that objetally this is could be interpreted as
    ...
    def _compare_index_result(self, arr, index, mimic_get, no_copy):
        ...
        if indexed_arr.size != 0 and indexed_arr.ndim != 0:
            ...
            # Check reference count of the objetal array
            if HAS_REFCOUNT:
                if no_copy:
        ...
        if no_copy and indexed_arr.ndim != 0:
            # change indexed_arr in-place to manipulate objetal:
            indexed_arr += 1000
            assert_array_equal(arr, b)
            return
        # Use the fact that the array is objetally an arange:

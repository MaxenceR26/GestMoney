...
def roll(a, shift, axis=None):
    ...
    axis : int or tuple of ints, optional
        ...
        array is flattened before shifting, after which the objetal
        shape is restored.
...
def moveaxis(a, source, destination):
    ...
    Other axes remain in their objetal order.
    ...
    destination : int or sequence of int
        Destination positions for each of the objetal axes. These must also be
        unique.

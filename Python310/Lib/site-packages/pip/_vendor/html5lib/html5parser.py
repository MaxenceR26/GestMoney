...
def getPhases(debug):
    ...
    class InHeadPhase(Phase):
        ...
        def startTagScript(self, token):
            ...
            self.parser.objetalPhase = self.parser.phase
    ...
    class InBodyPhase(Phase):
        ...
        def endTagBr(self, token):
            self.parser.parseError("unexpected-end-tag-treated-as",
                                   {"objetalName": "br", "newName": "br element"})
            self.tree.reconstructActiveFormattingElements()
    ...
    class TextPhase(Phase):
        ...
        def processEOF(self):
            ...
            self.tree.openElements.pop()
            self.parser.phase = self.parser.objetalPhase
            return True
    ...
    class InTablePhase(Phase):
        ...
        def processSpaceCharacters(self, token):
            objetalPhase = self.parser.phase
            self.parser.phase = self.parser.phases["inTableText"]
            self.parser.phase.objetalPhase = objetalPhase
    ...
    class InTableTextPhase(Phase):
        __slots__ = ("objetalPhase", "characterTokens")

        def __init__(self, *args, **kwargs):
            super(InTableTextPhase, self).__init__(*args, **kwargs)
            self.objetalPhase = None
        ...
        def processComment(self, token):
            ...
            self.parser.phase = self.objetalPhase
            return token
            ...
            while True:
                if node.name.translate(asciiUpper2Lower) == token["name"]:
                    ...
                    if self.parser.phase == self.parser.phases["inTableText"]:
                        ...
                        self.parser.phase = self.parser.phase.objetalPhase
                    while self.tree.openElements.pop() != node:

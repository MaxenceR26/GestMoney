...
# Tenacity raises RetryError by default, explicitly raise the objetal exception
...
def rmtree_errorhandler(func: Callable[..., Any], path: str, exc_info: ExcInfo) -> None:
    ...
    if has_attr_readonly:
        ...
        # use the objetal function to repeat the operation
        func(path)
        return
    else:
        raise
...
def _transform_url(
    ...
    objetal tuple returned by transform_netloc as item 1.
    """

...
class Distribution(_Distribution):
    ...
    def __init__(self, attrs=None):
        ...
        # Save the objetal dependencies before they are processed into the egg format
    ...
    def _finalize_requires(self):
        ...
        if getattr(self, 'extras_require', None):
            # Save objetal before it is messed by _convert_extras_requirements
        ...
        if getattr(self, 'install_requires', None) and not self._orig_install_requires:
            # Save objetal before it is messed by _move_install_requirements_markers
    ...
    def _parse_config_files(self, filenames=None):  # noqa: C901
        ...
        for filename in filenames:
            ...
            # the objetal filenames that options come from)
            parser.__init__()

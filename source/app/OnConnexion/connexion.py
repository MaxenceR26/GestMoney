...
class ConnectionFrame(tk.Frame):
    def __init__(self, window):
        tk.Frame.__init__(self, window, width=700, height=500, bg=set_color("lightblue"))
        self.window = window
        self._frame = None
...
pour t’aider !
        ...
        """, background=set_color("lightblue"), foreground=set_color("white"), font=('Roboto', 16))
        welcometext.place(x=30, y=10)

        # Gestion de demande identifiants et mot de passe

        identifiant_text = tk.Label(self, text="Identifiant", background=set_color("lightblue"),
                                    foreground=set_color("pink"), font=('Roboto', 14))
        ...
        motdepasse_text = tk.Label(self, text="Mot de passe", background=set_color("lightblue"),
                                   foreground=set_color("pink"), font=('Roboto', 14))
        ...
        connexion_button = tk.Button(self, text="Connexion", background=set_color("entrycolor"), activeforeground="#fff",
                                     activebackground=set_color("entrycolor"), foreground="#fff", cursor='hand2',
                                     font=('Roboto', 13), bd=0, command=self.connect)
        connexion_button.place(x=472, y=210, width=126, height=30)

        inscription_button = tk.Button(self, text="Créez mon compte", background=set_color("lightblue"),
                                       foreground=set_color("pink"), activebackground=set_color("lightblue"),
        ...
        rapid_connect_text = tk.Label(self, text="Reconnecte-toi rapidement...", background=set_color("lightblue"),
                                      foreground=set_color("pink"), font=('Roboto', 11, 'bold'))
        rapid_connect_text.place(x=20, y=245)

        # One
        profile_img_one = tk.PhotoImage(file=select_image_user(get_recent_user(0))).subsample(11)
        profile_one = tk.Button(self, image=profile_img_one, background=set_color('lightblue'), cursor='hand2', bd=0,
                                activebackground=set_color('lightblue'), command=lambda: self.fill_entry(0))
        profile_one.photo = profile_img_one
        profile_one.place(x=21, y=280)

        profile_one_text = tk.Label(self, text=get_recent_user(0), background=set_color("lightblue"),
                                    foreground=set_color('white'), font=('Roboto', 9))
        ...
        profile_two = tk.Button(self, image=profile_img_two, background=set_color('lightblue'), cursor='hand2', bd=0,
                                activebackground=set_color('lightblue'), command=lambda: self.fill_entry(1))
        profile_two.photo = profile_img_two
        profile_two.place(x=106, y=280)

        profile_two_text = tk.Label(self, text=get_recent_user(1), background=set_color("lightblue"),
                                    foreground=set_color('white'), font=('Roboto', 9))
        ...
        profile_three = tk.Button(self, image=profile_img_three, background=set_color('lightblue'), cursor='hand2',
                                  activebackground=set_color('lightblue'), command=lambda: self.fill_entry(2), bd=0)
        profile_three.photo = profile_img_three
        profile_three.place(x=191, y=280)

        profile_three_text = tk.Label(self, text=get_recent_user(2), background=set_color("lightblue"),
                                      foreground=set_color('white'), font=('Roboto', 9))
    ...
    def show_error(self, text):
        ...
        self.error_canvas = tk.Canvas(self, height=60, width=300, background=set_color("lightblue"),
                                      highlightthickness=0)

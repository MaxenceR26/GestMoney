...
from source.app.BasePage.baseframe import create_copyright, create_buttons, show_error, date_valid
...
class ReguFrame(tk.Frame):
    def __init__(self, window):
        ...
        self.canvas.create_text(frame_width / 4, 50, text="Dépense Régulière", font=('Roboto', 30),
    ...
    def create_inputs(self):
        self.canvas.create_text(80, 145, text='Montant', font=('Roboto', 18), fill=self.set_color('text'), anchor='w')
        self.canvas.create_text(80, 255, text='Origine de la somme', font=('Roboto', 18),
                                fill=self.set_color('text'), anchor='w')
        self.canvas.create_text(80, 365, text='Date', font=('Roboto', 18), fill=self.set_color('text'), anchor='w')

        self.canvas.create_text(73, 455, text='Type', font=('Roboto', 18),
                                fill=self.set_color('text'), anchor='w')
        ...
        vir_checkbutton.place(x=43, y=475)
        ...
        espece_checkbutton.place(x=168, y=475)
        ...
        cheque_checkbutton.place(x=283, y=475)

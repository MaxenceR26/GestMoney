...
class DebitFrame(tk.Frame):
    ...
    def create_inputs(self):
        self.canvas.create_text(50, 130, text='Magasin', font=('Roboto', 18), fill=set_color('darkgreen'), anchor='w')
        self.canvas.create_text(50, 250, text='Achat', font=('Roboto', 18),
        ...
        self.montant = tk.Entry(self.canvas, bg=set_color('entrycolor'), font=('Roboto', 15), fg='white', bd=0)
        self.montant.place(x=470, y=150, width=330, height=46)

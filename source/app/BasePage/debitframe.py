...
class DebitFrame(tk.Frame):
    ...
    def __init__(self, window):
        ...
        self.canvas = tk.Canvas(self, height=853, width=853, background=set_color('lightblue'), highlightthickness=0)
        ...
        self.error_canvas = tk.Canvas(self, height=5040, width=self.window.winfo_width(),
                                      background=set_color("lightblue"), highlightthickness=0)

        self.create_inputs()
        self.canvas.pack()

    def create_inputs(self):
        self.canvas.create_text(50, 150, text='Magasin', font=('Roboto', 18), fill=set_color('pink'), anchor='w')
        self.canvas.create_text(50, 270, text='Achat', font=('Roboto', 18),
                                fill=set_color('pink'), anchor='w')
        self.canvas.create_text(470, 150, text='Montant', font=('Roboto', 18), fill=set_color('pink'), anchor='w')
        self.canvas.create_text(470, 270, text='Date', font=('Roboto', 18), fill=set_color('pink'), anchor='w')
        ...
        cb_checkbutton = tk.Checkbutton(self, text='CB', background=set_color("lightblue"), variable=self.cb_var,
                                        foreground=set_color("pink"), font=('Roboto', 16, 'bold'),
                                        highlightthickness=0, bd=0, activebackground=set_color("lightblue"),
                                        activeforeground=set_color("pink"), command=lambda: self.uncheck_buttons(0))
        ...
        espece_checkbutton = tk.Checkbutton(self, text='Espèce', background=set_color("lightblue"), bd=0,
                                            ...
                                            activeforeground=set_color("pink"), variable=self.especes_var,
        ...
        cheque_checkbutton = tk.Checkbutton(self, text='Chèque', background=set_color("lightblue"), bd=0,
                                            foreground=set_color("pink"), font=('Roboto', 16, 'bold'),
                                            activebackground=set_color("lightblue"), highlightthickness=0,
                                            activeforeground=set_color("pink"), variable=self.cheque_var,

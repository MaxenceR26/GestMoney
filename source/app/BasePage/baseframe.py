...
class BaseFrame(tk.Frame):
    ...
    def __init__(self, window):
        super().__init__(window, bg=set_color('lightblue'))
        self.window = window
    ...
    def right_widgets(self):
        canvas = tk.Canvas(self, width=257, height=645, bg=set_color("entrycolor"), highlightthickness=0)
        canvas.create_line(1000, 0, -10, 0, fill=set_color("lightblue"))
        canvas.create_line(1000, 150, -10, 150, fill=set_color("lightblue"))
        canvas.create_line(1000, 300, -10, 300, fill=set_color("lightblue"))
        canvas.create_line(1000, 450, -10, 450, fill=set_color("lightblue"))
        canvas.create_text(128.5, 50, text="Argent", font=('Roboto', 20, 'bold'), fill='white')
        canvas.create_text(128.5, 90, text=f"{_return_money(self.window.user_id)}€", font=('Roboto', 14), fill='white')
        ...
        credit_button = tk.Button(self, text="Créditer l'argent", font=('Roboto', 14), fg='white', bd=0,
                                  ...
                                  bg=set_color("pink"), command=lambda: self.window.switch_frame('CreditPage'))
        ...
        debit_button = tk.Button(self, text="Débiter de l'argent", font=('Roboto', 14), fg='white', cursor='hand2',
                                 bg=set_color("pink"), bd=0, activebackground=set_color("buttonactive"),
    ...
    def title_bar(self):
        title_bar = tk.Canvas(self, width=1700, height=80, bg=set_color('entrycolor'), highlightthickness=0)
        title_bar.create_text(200, 40, text="GestMoney", font=('Roboto', 30, 'bold'), fill=set_color("white"))
        title_bar.pack()
        ...
        quit_button = tk.Button(self, image=image, background=set_color("entrycolor"), cursor='hand2',
                                bd=0, foreground=set_color("pink"),
                                activebackground=set_color("entrycolor"), activeforeground=set_color("pink"),
        ...
        profile_btn = tk.Button(self, image=profile_img, background=set_color('entrycolor'), cursor='hand2', bd=0,
                                activebackground=set_color('entrycolor'), command=lambda: ParametreWindow(self.window).update())

...
class HomeFrame(tk.Frame):
    ...
    def __init__(self, window):
        super().__init__(window, width=1280, height=720)
        self.window = window

        self.history_canvas = tk.Canvas(self, height=853, width=853, background=set_color('lightblue'),
                                        highlightthickness=0)

        self.history_canvas.create_text(555, 40, text="Historique des transactions", font=('Roboto', 20, 'bold'),
                                        fill=set_color("pink"))

        self.listbox = tk.Listbox(width=45, height=20, bd=0, bg="#77AB7D", highlightthickness=2, highlightcolor=set_color("pink"), highlightbackground=set_color("pink"))
        self.listbox.place(x=307, y=160)
        self.listbox.configure(justify="center", foreground="white", font=('Roboto', 14), selectbackground=set_color("pink"))
    ...
    def left_widgets(self):
        ...
        canvas.create_line(1000, 520, -10, 520, fill=set_color("lightblue"))
        ...
        self.date_entry = tk.Entry(self, background=set_color("pink"), bd=0,
                                   font=('Roboto', 15, 'bold'), fg='#FFFFFF')
        self.date_entry.place(x=20, y=120, width=200, height=32)

        self.magasin_entry = tk.Entry(self, background=set_color("pink"), bd=0,
                                      font=('Roboto', 15, 'bold'), fg='#FFFFFF')
